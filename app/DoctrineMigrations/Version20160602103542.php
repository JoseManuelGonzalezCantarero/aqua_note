 ...
 */
class Version20160602103542 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE genus ADD sub_family_id INT NOT NULL, DROP subfamily');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE genus ADD subfamily VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, DROP sub_family_id');
    }
}
